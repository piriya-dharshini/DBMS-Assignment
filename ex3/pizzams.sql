...
10.Display the order details that contains the pizza quantity more than the
...
11.Find the order(s) that contains Pan pizza but not the Italian pizza type.
...
12.Display the customer(s) who ordered both Italian and Grilled pizza type.
